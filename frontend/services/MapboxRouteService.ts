...
/**
 * Appelle l'API Mapbox Directions (profil driving) pour récupérer un itinéraire.
 * Cette fonction est prévue pour être utilisée côté serveur ou dans des actions.
 */
...
/**
 * Alias utilisé par certaines pages existantes.
 */
